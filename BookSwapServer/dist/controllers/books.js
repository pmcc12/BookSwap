...
function addOneBook(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            source === 'library'
                ? UserModel.findOneAndUpdate({ _id: userId }, { $push: { booksToSell: bookToInsert } }, { upsert: true }).then()
                : UserModel.findOneAndUpdate({ _id: userId }, { $push: { booksToBuy: bookToInsert } }, { upsert: true }).then();
            res.sendStatus(201);
        }
        catch (e) {
            res.sendStatus(500);
...
function removeOneBook(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const dbBooks = yield UserModel.findOne({ _id: userId });
            source === 'library'
